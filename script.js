...
document.getElementById("calender").valueAsDate = new Date();
...
document.getElementById("btn").addEventListener('click',function(){
  ...
  createStickyNote(text.value, topic.value);
});
  

createStickyNote = (text,topic) => {
  let note = document.createElement("div");
  let details = document.createElement("div");
  let noteText = document.createElement("h1");
  let noteTopic = document.createElement("h2");
  let dateElement = document.createElement("span");
  const d = new Date();
  dateElement.textContent=d.toLocaleString();
  ...
  noteTopic.textContent = "Topic : " + topic;
  dateElement.className = "date";
  document.getElementById("user_input").value="";
  document.getElementById("topic").value="";
  btn.onclick="save()";

  details.appendChild(noteTopic);
